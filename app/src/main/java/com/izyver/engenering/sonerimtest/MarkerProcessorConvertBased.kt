...
class MarkerProcessorConvertBased(screen: Point, markerDiameter: Int) :
    MarkerProcessor(screen, markerDiameter) {
    override fun getPointsForProjection(projection: Projection, zoom: Float): MutableList<MarkerPoint> {
